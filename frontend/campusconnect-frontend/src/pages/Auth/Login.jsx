...
export default function Login() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(180deg, rgba(246,248,255,1) 0%, rgba(251,250,255,1) 100%)",
      }}
    >
      <div className="max-w-3xl w-full grid grid-cols-1 md:grid-cols-2 rounded-3xl overflow-hidden z-10 gap-6">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(99,102,241,0.08), rgba(244,114,182,0.06))",
          }}
        >
          <div className="w-32 h-32 rounded-xl bg-white/10 flex items-center justify-center text-3xl font-bold text-indigo-700 mb-4">
            CC
          </div>
          ...
          <div className="mt-6 text-sm bg-white/10 px-3 py-2 rounded">
